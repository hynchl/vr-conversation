// // ----------------------------------------------------------------------------
// // <copyright file="AvatarInstantiation.cs" company="Exit Games GmbH">
...
//                 {
//                     this.ManualInstantiation(0, spawnPos, spawnRotation);
//                 }
//                 else
//                 {
//                     GameObject o = this.PrefabsToInstantiate[0];
//                     o.GetComponent<InitializeAvatar>().SetId(10);
...
// #if UNITY_EDITOR
//     [CustomEditor(typeof(AvatarInstantiation))]
//     public class AvatarInstantiationEditor : Editor
//     {
